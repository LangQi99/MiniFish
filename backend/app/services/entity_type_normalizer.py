...
def canonicalize_entity_type(raw_type: Optional[str]) -> str:
    ...
    org_tokens = {
        ...
        "government", "regulator", "university", "school", "institute", "ngo", "union",
        "association", "foundation", "media", "newspaper", "tv", "platform", "committee",
        "community", "account",
    }
    product_tokens = {
        "product", "app", "application", "service", "tool", "model", "software", "system",
        "api", "framework", "device", "game",
    }
    location_tokens = {
        "location", "place", "city", "country", "province", "region", "state", "county",
        "district", "area",
    }
