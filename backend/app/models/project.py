...
class ProjectStatus(str, Enum):
    ...
    PERSONAS_GENERATING = "personas_generating"
...
class Project:
    ...
    personas_task_id: Optional[str] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "personas_task_id": self.personas_task_id,
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'Project':
        ...
        return cls(
            ...
            personas_task_id=data.get('personas_task_id'),
...
class ProjectManager:
    ...
    @classmethod
    def get_personas_path(cls, project_id: str) -> str:
    ...
    def save_project(cls, project: Project) -> None:
        ...
        with open(cls._get_project_meta_path(project.project_id), 'w', encoding='utf-8') as f:
    ...
    def save_extracted_text(cls, project_id: str, text: str) -> None:
        with open(cls._get_project_text_path(project_id), 'w', encoding='utf-8') as f:
            f.write(text)
